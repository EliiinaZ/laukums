...
function irTrijsturis(m1, m2, m3) { //pārbauda vai eksist e trijstūris
    //pārbauda vai izpildās trijstūra nevienādība
    //atrgriež true vai flase
...
function rezultats() {
    ...
    if (!nolasa()) {
        ...
        if (irTrijsturis(m1,m2,m3)==false){
            ...
            t="Trijsūtirs ar malu garumiem "+m1+", "+m2+" un "+m3+" eksistē."; 
        if (m1==m2 && m2==m3){
